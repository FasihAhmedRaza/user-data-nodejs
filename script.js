...
BtnAllusers.addEventListener("click", () => {
  ...
  axios
    .get("https://crud-nodejs-fasih.herokuapp.com//users")
    .then((response) => {
...
Btncreate.addEventListener("click", () => {
  ...
  const URL = "https://crud-nodejs-fasih.herokuapp.com//user";
...
Btnuser.addEventListener("click", () => {
  ...
  document.getElementById("tbod").textContent = ""
  axios
    .get(`https://crud-nodejs-fasih.herokuapp.com//user/${InpgetUser}`)
    .then((response) => {
      //console.log(response.data);
...
BtnEdit.addEventListener("click", () => {
  ...
  axios
    .put(`https://crud-nodejs-fasih.herokuapp.com//user/${editid}`, {
      name: editNam,
      email: editEmai,
      address: editAddr,
    })
...
BtnDel.addEventListener("click", () => {
  ...
  axios
    .delete(`https://crud-nodejs-fasih.herokuapp.com//user/${DeleID}`)
    .then((response) => {
